...
import tgm.aahuja.warehouse.model.Warehouse;

/**
 */
@javax.annotation.Generated(value = "by gRPC proto compiler (version 1.61.0)",
...
public final class WarehouseServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<
      Warehouse.WarehouseRequest, Warehouse.WarehouseData> getGetDataMethod;

  @io.grpc.stub.annotations.
  RpcMethod(fullMethodName = SERVICE_NAME + '/' + "getData",
            requestType = Warehouse.WarehouseRequest.class,
            responseType = Warehouse.WarehouseData.class,
            methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc
      .MethodDescriptor<Warehouse.WarehouseRequest, Warehouse.WarehouseData>
      getGetDataMethod() {
    io.grpc.MethodDescriptor<Warehouse.WarehouseRequest,
                             Warehouse.WarehouseData> getGetDataMethod;
    if ((getGetDataMethod = WarehouseServiceGrpc.getGetDataMethod) == null) {
      synchronized (WarehouseServiceGrpc.class) {
        if ((getGetDataMethod = WarehouseServiceGrpc.getGetDataMethod) ==
            null) {
          WarehouseServiceGrpc.getGetDataMethod = getGetDataMethod =
              io.grpc.MethodDescriptor
                  .<Warehouse.WarehouseRequest,
                    Warehouse.WarehouseData>newBuilder()
                  .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                  .setFullMethodName(
                      generateFullMethodName(SERVICE_NAME, "getData"))
                  .setSampledToLocalTracing(true)
                  .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                      Warehouse.WarehouseRequest.getDefaultInstance()))
                  .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                      Warehouse.WarehouseData.getDefaultInstance()))
                  .setSchemaDescriptor(
                      new WarehouseServiceMethodDescriptorSupplier("getData"))
                  .build();
        }
      }
    }
  ...
  public static WarehouseServiceStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<WarehouseServiceStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<WarehouseServiceStub>() {
          @java.lang.Override
          public WarehouseServiceStub newStub(io.grpc.Channel channel,
   ...
   */
  public static WarehouseServiceBlockingStub
  newBlockingStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub
        .StubFactory<WarehouseServiceBlockingStub> factory =
        new io.grpc.stub.AbstractStub
            .StubFactory<WarehouseServiceBlockingStub>() {
              @java.lang.Override
              public WarehouseServiceBlockingStub newStub(
   ...
   * service
   */
  public static WarehouseServiceFutureStub
  newFutureStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<WarehouseServiceFutureStub> factory =
        new io.grpc.stub.AbstractStub
            .StubFactory<WarehouseServiceFutureStub>() {
              @java.lang.Override
              public WarehouseServiceFutureStub newStub(
                  io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public interface AsyncService {
    ...
    default void getData(
        Warehouse.WarehouseRequest request,
        io.grpc.stub.StreamObserver<Warehouse.WarehouseData> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetDataMethod(),
                                                           responseObserver);
    }
  }
  ...
  public static final class WarehouseServiceBlockingStub
    ...
    @java.lang.Override
    protected WarehouseServiceBlockingStub
    ...
    /**
     */
    public Warehouse.WarehouseData getData(Warehouse.WarehouseRequest request) {
  ...
  public static final class WarehouseServiceFutureStub
    ...
    @java.lang.Override
    protected WarehouseServiceFutureStub
    build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new WarehouseServiceFutureStub(channel, callOptions);
    }
    ...
    public com.google.common.util.concurrent
        .ListenableFuture<Warehouse.WarehouseData>
        getData(Warehouse.WarehouseRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp>
    ...
    public void invoke(Req request,
      ...
      case METHODID_GET_DATA:
        serviceImpl.getData(
            (Warehouse.WarehouseRequest)request,
            (io.grpc.stub.StreamObserver<Warehouse.WarehouseData>)
                responseObserver);
        break;
      default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(getGetDataMethod(),
                   io.grpc.stub.ServerCalls.asyncUnaryCall(
                       new MethodHandlers<Warehouse.WarehouseRequest,
  ...
  private static abstract class WarehouseServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return Warehouse.getDescriptor();
    }
        ...
        if (result == null) {
          serviceDescriptor = result =
              io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
                  .setSchemaDescriptor(
                      new WarehouseServiceFileDescriptorSupplier())
                  .addMethod(getGetDataMethod())
                  .build();
        }
      }
